...
public class Game {
	...
	private boolean processCommand(String command) {
		...
		if (command.equals(Language.HELP_WORD.toString())) System.out.println(Language.HELP);
		else if (command.equals(Language.QUIT_WORD.toString())) quit(command);
		else if (command.equals(Language.COFFEE_WORD.toString())) currentRoom.use(new Coffee(), player);
		else if (command.equals(Language.LIGHTS_WORD.toString())) currentRoom.switchLight();
		else if (command.equals("babyfoot")) currentRoom.use(new Babyfoot(), player);
		else if (command.equals("stats")) printStats();
		else goRoom(command);
		return wantToQuit;
	}
