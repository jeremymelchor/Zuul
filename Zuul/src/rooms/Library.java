 ...
 * 
 *         Create the Library room with some actions associate to it
 */
public class Library extends Room {
	...
	/**
	 * in the library you can : 1. find the book Objects first with Java, making
	 * you instantly know every lectures. 2. find a tablet in which you will
	 * either player a video game, or see an on-line course.
	 */
	@Override
	public void action(Player player) {
		...
		if (random.creatingTheCheatBook()) {
			...
			System.out.println(Language.POO_BOOK);
		}
	...
	/**
	 * A method checking if the library is open (because if it's not, you can't
	 * enter the room...)
	 */
	@Override
